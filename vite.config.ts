...
export default defineConfig({
  ...
  /* server: {
     port: 443,
     https: {
       cert: readFileSync(resolve(dirname(fileURLToPath(import.meta.url)), './mkcerts/cube-hack-on-ton.ru+1.pem')),
       key: readFileSync(resolve(dirname(fileURLToPath(import.meta.url)), './mkcerts/cube-hack-on-ton.ru+1-key.pem')),
     },
     host: 'app.cube-hack-on-ton.ru',
  }, */
  publicDir: './public',
});
